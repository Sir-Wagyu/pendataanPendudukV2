    ...
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
        <div class="px-3 py-4 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between md:mx-3">
                ...
                <p class="text-xl font-semibold sm:text-2xl whitespace-nowrap text-warna-300">Penduduk Pendatang Desa X</p>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-warna-100">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/dashboard"
                    class="{{ request()->is('dashboard') ? 'bg-warna-200 text-warna-300' : '' }} flex items-center p-2 text-warna-300 hover:bg-warna-200 hover:text-warna-300 group rounded-lg ">
                ...
                <li>
                    <a href="{{ route('verifikasiAkun') }}"
                        class="{{ request()->is('verifikasi-akun') ? 'bg-warna-200 text-warna-300' : '' }} flex items-center p-2 text-warna-300 hover:bg-warna-200 hover:text-warna-300 group rounded-lg ">
                ...
                <li>
                    <a href="/data-penduduk"
                        class="{{ request()->is('data-penduduk') ? 'bg-warna-200 text-warna-300' : '' }} flex items-center p-2 text-warna-300 hover:bg-warna-200 hover:text-warna-300 group rounded-lg ">
                ...
                <li>
                    <a href="/laporan"
                        class="{{ request()->is('laporan') ? 'bg-warna-200 text-warna-300' : '' }} flex items-center p-2 text-warna-300 hover:bg-warna-200 hover:text-warna-300 group rounded-lg">
                ...
                <li>
                    ...
                    class="w-full flex items-center p-2 text-warna-800 rounded-lg group hover:bg-warna-200"
