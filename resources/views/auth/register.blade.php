            ...
            <div class="mt-4 md:mt-20 lg:mt-20 w-full">
                  ...
                  <form action="{{ route('registerSubmit') }}" method="post">
                        ...
                        <div class="mt-15">
                              ...
                              @if ($errors->has('email'))
                                    <span class="text-warna-800">{{ $errors->first('email') }}</span>
                              @endif
                              <button class="px-3 py-2 md:py-3 rounded-md bg-warna-400 hover:bg-warna-400/90 active:scale-95 transition-all text-warna-100 w-full mt-8 lg:mt-10">Registrasi</button>
